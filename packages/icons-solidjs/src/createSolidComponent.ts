...
const createSolidComponent = (iconName: string, iconNamePascal: string, iconNode: IconNode) => {
  const Component = (props: IconProps) => {
    ...
    const svgProps = {
      ...
      'stroke-width': () =>
        localProps.stroke != null ? localProps.stroke : defaultAttributes['stroke-width'],
      class: () =>
